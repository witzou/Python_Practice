...
###### 需要配置以下几项：
annotation_path = 'D:/competition/Part_B/train_data/annotations/'#clw note：添加自己的Pascal VOC的annotation文件路径'
my_classes = ['background','head']    #clw note：第二项，添加自己的class，比如person,dog,car等等；目前不知多分类是否可以
save_json_path = 'D:/competition/Part_B/train_data/clw_pascal2coco.json' #clw note:保存json的文件路径
