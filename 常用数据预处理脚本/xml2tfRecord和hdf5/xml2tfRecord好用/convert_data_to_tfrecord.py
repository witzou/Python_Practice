...
# clw note：注意下面字符串结尾的/不要丢了，否则瞬间就会Conversion is complete!
tf.app.flags.DEFINE_string('VOC_dir', 'F:/deep_learning/competion/2019yaogan/train/train/', 'Voc dir')  #clw modify
#tf.app.flags.DEFINE_string('VOC_dir', '/home/clwclw/dataset/DOTA/train/', 'Voc dir')  #clw modify：for Ubuntu
tf.app.flags.DEFINE_string('xml_dir', 'labelTxt', 'xml dir')  #clw modify
            ...
            for child_item in child_of_root:
                ...
                if child_item.tag == 'bndbox':
                    ...
                    for node in child_item:
                        ...
                        tmp_box.append(float(node.text))  # clw modify
...
def convert_pascal_to_tfrecord():
    ...
    writer = tf.python_io.TFRecordWriter(path=save_path) #clw note：这里不要搞成ZLIB了！！

    #writer_options = tf.python_io.TFRecordOptions()  #clw modify
    #writer = tf.python_io.TFRecordWriter(path=save_path, writer_options)
    #print('clw:', writer_options.input_buffer_size)
